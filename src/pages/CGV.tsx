  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100">
      ...
      <motion.div
        ...
        className="relative max-w-4xl mx-auto px-6 py-16 mt-8"
      >
        {/* Card principale */}
      ...
      >
        <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-8 border border-slate-200/60">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20 space-y-16">
        ...
        >
          <div className="flex items-start gap-6">
            <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-primary/10 to-primary/5 rounded-full flex items-center justify-center">
        ...
        >
          <div className="inline-block bg-white rounded-2xl px-12 py-8 shadow-lg border border-slate-200">
